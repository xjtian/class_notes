...
\begin{itemize}
	\itemsep=-3pt
	\item[-] Divide by halving arrays, conquer by merging
	\item[-] $O(n\log n)$ runtime
\end{itemize}
}
\rhead{}
...
\section{Runtime}
	\begin{itemize}
		...
		\marginnote{Runtime of Mergesort?}
	\end{itemize}
