...
\section{Complex Fourier Series}
	...
	Substitution gives
	\begin{IEEEeqnarray}{rCl}
		f(x) & = & \frac{1}{2}a_0 + \sum_{n=1}^\infty \frac{a_n}{2}e^{i(n\pi x/L)} + \sum_{n=-1}^{-\infty} \frac{a_{-n}}{2}e^{i(n\pi x/L)}\\\nonumber
		&& + \sum_{n=1}^\infty -\frac{b_n}{2i}e^{i(n\pi x/L)} + \sum_{n=1}^{-\infty} -\frac{b_{-n}}{2i}e^{i(n\pi x/L)}
	\end{IEEEeqnarray}
